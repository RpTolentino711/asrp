...
<body>
    ...
    <script>
        // --- ENHANCED NOTIFICATION SYSTEM (EXCLUDING MAINTENANCE POPUPS) ---
        ...
        console.log('Initial counts - Unseen Rentals: <?= $unseen_rentals ?>, Unread Messages: <?= $unread_client_messages ?>');
        ...
        // Show rental notification (ONLY rental notifications - no maintenance notifications on maintenance page)
            ...
            fetch('../AJAX/ajax_admin_dashboard_counts.php')
                ...
                .then(data => {
                    ...
                    if (data && !data.error) {
                        ...
                        // Check for new rental requests (NO maintenance notifications on maintenance page)
        ...
        document.addEventListener('DOMContentLoaded', () => {
            console.log('Maintenance page fully loaded with ENHANCED notification system');
            console.log('Test notifications with: testNotification("rental") or testNotification("client_message")');
